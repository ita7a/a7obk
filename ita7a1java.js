...
div#users img.fl.ustat {
    ...
    margin: 1;
    margin-right: -38.5px;-primary").css("border-radius","24px 24px 24px 24px")
...
ul.nav.nav-tabs.fl li a {      color: #620070;  box-shadow: inset 0 2px 2px rgb(112, 112, 113), 0 0 8px rgb(112, 112, 113);font-size: 13px!important;padding: 6px!important;text-align: center!important;width: 100%;}
